...
`).map(t=>t.trim()).join(" ")};we.O=function(e){return this.inspectOpts.colors=this.useColors,_.inspect(e,this.inspectOpts)}});var ve=f((mt,V)=>{typeof process=="undefined"||process.type==="renderer"||process.browser===!0||process.__nwjs?V.exports=me():V.exports=Fe()});var Oe=f((Ct,et)=>{et.exports={version:"4.3.0",name:"prisma",description:"Prisma is an open-source database toolkit. It includes a JavaScript/TypeScript ORM for Node.js, migrations and a modern GUI to view and edit the data in your database. You can use Prisma in new projects or add it to an existing one.",keywords:["orm","prisma2","prisma","cli","database","sql","postgresql","mysql","sqlite","mariadb","mssql","typescript","query-builder"],main:"build/index.js",repository:{type:"git",url:"https://github.com/prisma/prisma.git",directory:"packages/cli"},homepage:"https://www.prisma.io",author:"Tim Suchanek <suchanek@prisma.io>",bugs:"https://github.com/prisma/prisma/issues",license:"Apache-2.0",engines:{node:">=14.17"},prisma:{prismaCommit:"d4e397ef893ce3e530adcbf5ea0d9e7bb1e101e2"},files:["README.md","build","install","runtime/*.js","runtime/*.d.ts","runtime/utils","runtime/dist","runtime/llhttp","prisma-client","preinstall","scripts/preinstall-entry.js","scripts/install-entry.js"],pkg:{assets:["build/**/*","runtime/**/*","prisma-client/**/*","node_modules/@prisma/engines/**/*","node_modules/@prisma/engines/*"]},bin:{prisma:"build/index.js",prisma2:"build/index.js"},devDependencies:{"@prisma/client":"workspace:4.3.0","@prisma/debug":"workspace:4.3.0","@prisma/fetch-engine":"workspace:4.3.0","@prisma/generator-helper":"workspace:4.3.0","@prisma/get-platform":"workspace:4.3.0","@prisma/internals":"workspace:4.3.0","@prisma/migrate":"workspace:4.3.0","@prisma/studio":"0.473.0","@prisma/studio-server":"0.473.0","@swc/core":"1.2.242","@swc/jest":"0.2.22","@types/debug":"4.1.7","@types/fs-extra":"9.0.13","@types/jest":"28.1.7","@types/rimraf":"3.0.2","@types/ws":"8.5.3",chalk:"4.1.2","checkpoint-client":"1.1.21",debug:"4.3.4",dotenv:"16.0.1",esbuild:"0.15.5",execa:"5.1.1","fast-deep-equal":"3.1.3","fs-extra":"10.1.0","fs-jetpack":"4.3.1","get-port":"5.1.1","global-dirs":"3.0.0","is-installed-globally":"0.4.0",jest:"28.1.3","jest-junit":"14.0.0","line-replace":"2.0.1","log-update":"4.0.0","make-dir":"3.1.0","node-fetch":"2.6.7",open:"7.4.2","pkg-up":"3.1.0","replace-string":"3.1.0","resolve-pkg":"2.0.0",rimraf:"3.0.2","strip-ansi":"6.0.1",tempy:"1.0.1","ts-pattern":"4.0.5",typescript:"4.7.4"},scripts:{dev:"DEV=true node -r esbuild-register helpers/build.ts",build:"node -r esbuild-register helpers/build.ts",test:"jest --maxConcurrency=1 --verbose",install:"node scripts/install-entry.js",tsc:"tsc -d -p tsconfig.build.json",preinstall:"node scripts/preinstall-entry.js",prepublishOnly:"pnpm run build"},dependencies:{"@prisma/engines":"workspace:4.3.0"},sideEffects:!1}});var fs=require("fs"),path=require("path"),pkgUp=le(),Debug=ve(),debug=Debug("prisma:install"),pkg=Oe(),pkgName=pkg.name;process.env.INIT_CWD&&process.env.NOW_BUILDER&&ensurePostInstall().catch(e=>{debug(e)});async function ensurePostInstall(){let initPkgPath=eval("require('path').resolve(process.env.INIT_CWD, 'package.json')");if(fs.existsSync(initPkgPath)){if(addPostInstallHook(initPkgPath))return}else{let e=path.join(process.cwd(),".."),t;do t=await pkgUp({cwd:e}),e=path.join(t,"../..");while(t&&!addPostInstallHook(t))}}s(ensurePostInstall,"ensurePostInstall");function addPostInstallHook(e){let t=JSON.parse(fs.readFileSync(e,"utf-8"));return!t.dependencies[pkgName]&&!t.devDependencies[pkgName]?!1:(t.scripts=t.scripts||{},t.scripts.postinstall?t.scripts.postinstall.includes("prisma generate")||(t.scripts.postinstall=`prisma generate || true && ${t.scripts.postinstall}`):t.scripts.postinstall="prisma generate || true",fs.writeFileSync(e,JSON.stringify(t,null,2)),!0)}s(addPostInstallHook,"addPostInstallHook");
