...
var require_package2 = __commonJS({
  "../internals/package.json"(exports, module2) {
    module2.exports = {
      ...
      dependencies: {
        "@prisma/debug": "workspace:4.3.0",
        "@prisma/engine-core": "workspace:4.3.0",
        "@prisma/engines": "workspace:4.3.0",
        "@prisma/fetch-engine": "workspace:4.3.0",
        "@prisma/generator-helper": "workspace:4.3.0",
        "@prisma/get-platform": "workspace:4.3.0",
  ...
  "package.json"(exports, module2) {
    module2.exports = {
      ...
      devDependencies: {
        ...
        "@prisma/generator-helper": "workspace:4.3.0",
        "@prisma/get-platform": "workspace:4.3.0",
        "@prisma/instrumentation": "workspace:4.3.0",
        "@prisma/internals": "workspace:4.3.0",
        "@prisma/migrate": "workspace:4.3.0",
...
function needsGenericModelArg(type) {
  var _a2;
  const toVisit = [type];
...
__name(needsGenericModelArg, "needsGenericModelArg");
function inputTypeNeedsGenericModelArg(inputType) {
  return needsGenericModelArg({ type: inputType, location: "inputObjectTypes", isList: false });
}
__name(inputTypeNeedsGenericModelArg, "inputTypeNeedsGenericModelArg");
...
var InputField = class {
  constructor(field, prefixFilter = false, noEnumerable = false, source) {
    this.field = field;
...
function stringifyInputType(t2, prefixFilter, noEnumerable = false, source) {
  var _a2;
...
function stringifyInputTypes(inputTypes, prefixFilter, noEnumerable = false, source) {
  ...
  const stringifiedNonInputTypes = nonInputObjectTypes.map((type) => stringifyInputType(type, prefixFilter, noEnumerable, source)).join(" | ");
...
var MinimalArgsType = class {
  constructor(args, type, action, generatedTypeName = getModelArgName(type.name, action)) {
    this.args = args;
    this.type = type;
    this.action = action;
...
${(0, import_indent_string7.default)(
      relations.map(
        (f2) => `P extends '${f2.name}' ? ${this.wrapType(
          f2,
          `${getPayloadName(f2.outputType.type.name)}<S['${projection}'][P]>`
        )} :`
      ).join("\n"),
      6
    )} ${selectPrefix} never
...
// src/generation/TSClient/Model.ts
var Model = class {
  constructor(model, dmmf2, generator2) {
    this.model = model;
    this.dmmf = dmmf2;
    this.generator = generator2;
  ...
  get argsTypes() {
    ...
    for (const action of allClientModelActions) {
      ...
      if (action === "updateMany" || action === "deleteMany" || action === "createMany") {
        argsTypes.push(new MinimalArgsType(field.args, this.type, action));
      } else if (action === "findRaw" || action === "aggregateRaw") {
        argsTypes.push(new MinimalArgsType(field.args, this.type, action));
      } else if (action !== "groupBy" && action !== "aggregate") {
        argsTypes.push(new ArgsType(field.args, this.type, action));
      }
    }
...
var Count = class {
  constructor(type, dmmf2, generator2) {
    this.type = type;
    this.dmmf = dmmf2;
    this.generator = generator2;
  }
  get argsTypes() {
    ...
    for (const field of this.type.fields) {
      if (field.args.length > 0) {
        argsTypes.push(
          new MinimalArgsType(field.args, this.type, void 0, getCountArgsType(this.type.name, field.name))
        );
      }
    }
    return argsTypes;
...
`;
  ...
  toTS(edge = false) {
    ...
    const countTypes = this.dmmf.schema.outputObjectTypes.prisma.filter((t2) => t2.name.endsWith("CountOutputType")).map((t2) => new Count(t2, this.dmmf, this.options.generator));
    const code = `
/**
 * Client
**/
...
${(_e = (_d = this.dmmf.inputObjectTypes.model) == null ? void 0 : _d.map((inputType) => new InputType(inputType).toTS()).join("\n")) != null ? _e : ""}
