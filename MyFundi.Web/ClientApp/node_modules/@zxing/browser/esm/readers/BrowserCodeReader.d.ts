...
export declare class BrowserCodeReader {
     ...
     */
    static mediaStreamIsTorchCompatible(params: MediaStream): Promise<boolean>;
    /**
     *
     * @param track The media stream track that will be checked for compatibility.
     */
    static mediaStreamIsTorchCompatibleTrack(track: MediaStreamTrack): Promise<boolean>;
    /**
     ...
     */
    protected static playVideoOnLoad(element: HTMLVideoElement, callbackFn: EventListener): Promise<boolean>;
    /**
     * Waits for a video to load and then hits play on it.
     */
    protected static playVideoOnLoadAsync(videoElement: HTMLVideoElement): Promise<void>;
    /**
     ...
     */
    protected static attachStreamToVideo(stream: MediaStream, preview?: string | HTMLVideoElement): Promise<HTMLVideoElement>;
