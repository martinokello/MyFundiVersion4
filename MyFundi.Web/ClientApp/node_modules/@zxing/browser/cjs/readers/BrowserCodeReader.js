...
var BrowserCodeReader = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, BrowserCodeReader.mediaStreamIsTorchCompatibleTrack(track)];
                    case 3:
                        if (_b.sent()) {
    ...
    BrowserCodeReader.mediaStreamIsTorchCompatibleTrack = function (track) {
        return __awaiter(this, void 0, void 0, function () {
            var imageCapture, capabilities, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, 'torch' in capabilities || ('fillLightMode' in capabilities && capabilities.fillLightMode.length > 0)];
                    case 2:
                        err_1 = _a.sent();
     ...
     */
    BrowserCodeReader.playVideoOnLoad = function (element, callbackFn) {
        return __awaiter(this, void 0, void 0, function () {
            var videoCanPlayListener, isPlaying;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        videoCanPlayListener = function () { return BrowserCodeReader.tryPlayVideo(element); };
     ...
     */
    BrowserCodeReader.playVideoOnLoadAsync = function (videoElement) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    _a.trys.push([0, 2, , 3]);
                                    return [4 /*yield*/, BrowserCodeReader.playVideoOnLoad(videoElement, function () { return resolve(); })];
                                case 1:
                                    _a.sent();
                                    return [3 /*break*/, 3];
                                case 2:
     ...
     */
    BrowserCodeReader.attachStreamToVideo = function (stream, preview) {
        return __awaiter(this, void 0, void 0, function () {
            var videoElement;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, BrowserCodeReader.playVideoOnLoadAsync(videoElement)];
                    case 1:
                        _a.sent();
    ...
    BrowserCodeReader.prototype.decode = function (element) {
        ...
        var binaryBitmap = BrowserCodeReader.createBinaryBitmapFromMediaElem(element);
    ...
    BrowserCodeReader.prototype.decodeFromStream = function (stream, preview, callbackFn) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var previewReceived, video, finalizeCallback, isTorchAvailable, torchTrack, originalControls, switchTorch, stop, controls;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        previewReceived = Boolean(preview);
                    ...
                    case 1:
                        ...
                        torchTrack = (_a = stream
                            .getVideoTracks()) === null || _a === void 0 ? void 0 : _a.find(function (t) { return BrowserCodeReader.mediaStreamIsTorchCompatibleTrack(t); });
                        originalControls = this.scan(video, callbackFn, finalizeCallback);
                        switchTorch = function (onOff) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        if (!isTorchAvailable) {
                                        ...
                                        return [4 /*yield*/, BrowserCodeReader.mediaStreamSetTorch(torchTrack, onOff)];
                                    case 1:
                                        _a.sent();
                                        return [2 /*return*/];
                                }
                        ...
                        controls = __assign(__assign({}, originalControls), { stop: stop,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        // plays the video
                        return [4 /*yield*/, BrowserCodeReader.playVideoOnLoadAsync(element)];
                    case 1:
                        // plays the video
                        _a.sent();
    ...
    BrowserCodeReader.prototype.decodeFromVideoUrl = function (url, callbackFn) {
        return __awaiter(this, void 0, void 0, function () {
            var element, finalizeCallback, controls;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!url) {
