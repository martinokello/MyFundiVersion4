        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FundiProfileId = table.Column<int>(nullable: false),
                    JobId = table.Column<int>(nullable: true),
                    FundiAddressId = table.Column<int>(nullable: true),
                    ...
                    Date1stPayment = table.Column<DateTime>(nullable: false),
                    FirstPaymentAmount = table.Column<decimal>(nullable: false),
                    Date2ndPayment = table.Column<DateTime>(nullable: false),
                    SecondPaymentAmount = table.Column<decimal>(nullable: false),
                    Date3rdPayment = table.Column<DateTime>(nullable: false),
                    ThirdPaymentAmount = table.Column<decimal>(nullable: false),
                    Date4thPayment = table.Column<DateTime>(nullable: false),
                    ForthPaymentAmount = table.Column<decimal>(nullable: false),
                    DateCreated = table.Column<DateTime>(nullable: false),
                    DateUpdated = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClientFundiContracts_Addresses_ClientAddressId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_ClientFundiContracts_Addresses_FundiAddressId",
                        column: x => x.FundiAddressId,
                        principalTable: "Addresses",
                        principalColumn: "AddressId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_ClientFundiContracts_Jobs_JobId",
                        column: x => x.JobId,
                        principalTable: "Jobs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientFundiContracts_ClientAddressId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientFundiContracts_FundiAddressId",
                table: "ClientFundiContracts",
                column: "FundiAddressId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientFundiContracts_JobId",
                table: "ClientFundiContracts",
                column: "JobId");
